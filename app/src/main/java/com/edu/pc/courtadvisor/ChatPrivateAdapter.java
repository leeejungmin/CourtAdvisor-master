...
public class ChatPrivateAdapter extends RecyclerView.Adapter<ChatPrivateAdapter.ViewHolder> {
    ...
    public ChatPrivateAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.chat_private_item, parent, false);

        return new ChatPrivateAdapter.ViewHolder(v);
    }


    @Override
    public void onBindViewHolder(ChatPrivateAdapter.ViewHolder holder, int position) {
    ...
    public ChatPrivateAdapter(String[] dataSet) {
        mDataSet = dataSet;
    }
